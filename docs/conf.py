...
project = u'OpacPlot'
copyright = u'2012, The FLASH Center'

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
#
from opacplot import __version__
...
html_logo = '_static/flash-logo.png'
...
latex_documents = [
  ('index', 'opacplot.tex', u'OpacPlot Documentation',
   u'The FLASH Center', 'manual'),
]
...
man_pages = [
    ('index', 'opacplot', u'OpacPlot Documentation',
     [u'The FLASH Center'], 1)
]
